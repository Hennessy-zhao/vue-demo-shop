<template>
	<el-container id="container">
		...
		<el-aside width="250px">
			...
			<el-menu :default-active="$route.path" style="height:100%" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b" @select="selectItem">
				<el-submenu index="1">
					<template #title>
				...
				<el-submenu index="2">
					...
					<el-menu-item index="/home/goodCategory">商品分类</el-menu-item>
				</el-submenu>
